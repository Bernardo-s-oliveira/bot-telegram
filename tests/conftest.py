...
def config_padrao(monkeypatch):
    ...
    for chave, valor in dict(
        ...
        variedade_janela_horas=4, apple_ativo=True, apple_max_posts=3, apple_queda_minima=5, apple_so_queda=True, apple_palavras_bloqueadas=["recondicionado", "seminovo", "usado", "vitrine", "open box", "caixa aberta", "swap"], chat_id_apple="", pessoal_ativo=True, pessoal_max_posts=3, chat_id_pessoal="", mix_ativo=False, mix_janela_posts=40, mix_forca=1.5, mix_tecnologia_preco_max=300.0, mix_eletro_exige_queda=True, divulgacao_ativa=True, divulgacao_a_cada_horas=24, divulgacao_fixar=False,
